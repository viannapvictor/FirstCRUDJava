...
public class App {
        ...
        while (isOpcaoValida(opcao)) {
            ...
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por vígula, conforme exemplo: Nome, CPF," +
                                " Telefone, Endereço, Número, Cidade e Estado",
                        "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                cadastrar(dados);
    ...
    private static void consultar(String dados) {
        ...
        if (cliente != null) {
            ...
            JOptionPane.showMessageDialog(null, "Cliente não encontrado: ", "Sucesso",
